...
llmDescription: "Argyros documentation home. Argyros is a best-price swap aggregator on Fogo with multi-hop routing across Vortex, Fluxbeam, Fogo.fun, and Moonit bonding curves, exposed via three endpoints (GET /api/v1/quote, POST /api/v1/swap, POST /api/v1/instructions). Includes a quickstart cURL example (1 SOL to USDC) and links to the SDK, widget, and API reference. Solana support coming soon."
---
    ...
    <div className="z-10 relative">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        <a
          ...
          className="inline-flex items-center justify-center px-8 py-3 bg-[#e8eaef] hover:bg-[#c9ced6] text-[#08080a] font-semibold rounded-xl transition-all shadow-lg hover:shadow-[#c9ced6]/30"
        >
          Get Started
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <div className="p-8 rounded-2xl bg-gradient-to-b from-white to-gray-50 dark:from-[#121214] dark:to-[#08080a] border border-gray-100 dark:border-zinc-800 hover:border-[#c9ced6]/50 transition-colors group">
        <div className="w-12 h-12 rounded-lg bg-[#c9ced6]/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
           <svg className="w-6 h-6 text-[#c9ced6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 7m0 13V7" /></svg>
        </div>
      ...
      <div className="p-8 rounded-2xl bg-gradient-to-b from-white to-gray-50 dark:from-[#121214] dark:to-[#08080a] border border-gray-100 dark:border-zinc-800 hover:border-[#c9ced6]/50 transition-colors group">
        <div className="w-12 h-12 rounded-lg bg-[#c9ced6]/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
           <svg className="w-6 h-6 text-[#c9ced6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
        </div>
      ...
      <div className="p-8 rounded-2xl bg-gradient-to-b from-white to-gray-50 dark:from-[#121214] dark:to-[#08080a] border border-gray-100 dark:border-zinc-800 hover:border-[#c9ced6]/50 transition-colors group">
        <div className="w-12 h-12 rounded-lg bg-[#c9ced6]/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
           <svg className="w-6 h-6 text-[#c9ced6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
        </div>
