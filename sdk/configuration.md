...
description: "Configure the ArgyrosSDK client: API key, base URL, chain selection, and retry behavior."
llmDescription: "Configuration reference for the Argyros TypeScript SDK. Documents the SDKConfig object passed to the ArgyrosSDK constructor: apiKey, baseUrl, chain (fogo; solana coming soon), and retry behavior (retries, backoff). Includes a self-hosted API base URL override."
---
